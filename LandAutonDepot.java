...
@Autonomous(name = "RedAirDepot", group = "test")
...
public class LandAutonDepot extends LinearOpMode{
    //declares all motors
   ...
   // @Override
    ...
    wristSpin(-0.50, 900);
    armSpin(0.75, 400);
    intakeSpin(-1.00, 1600); // Spit the team marker out 
