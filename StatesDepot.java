...
@Autonomous(name = "StatesDepot", group = "Testing")

public class StatesDepot extends LinearOpMode {
    ...
    private OpticalDistanceSensor HangingODS;
    ...
    public void runOpMode() {
        ...
        //VEX motors
        leftIntakeServo.setPower(0.005); 
        rightIntakeServo.setPower(-0.005);
                        ...
                        if (goldMineralX != -1 && silverMineral1X != -1 /*&& silverMineral2X != -1*/) {
                          if (goldMineralX < silverMineral1X) {
                            ...
                            //knock off left mineral
                                ...
                                //driveForward(-1.00, 400);
                                
                                // //drive to depot
                                // turnLeft(1.00, 600);
                                // driveForward(1.00, 2000);
                                // turnRight(1.00, 500);
                                // driveForward(1.00, 2000);
                                driveForward(1.00, 750);
                                turnRight(1.00, 310);
                                strafeLeft(1.00, 500);
                                driveForward(-1.00, 200);
                            ...
                            //knock off middle mineral
                                ...
                                //drive to depot
                                turnLeft(1.00, 920);
                                driveForward(1.00, 1800);
                                turnRight(1.00, 1070);
                                driveForward(1.00, 1800);
                                
                                intakeSpin(1.00, 2000);
                                
                                driveForward(-1.00, 2650);
                                turnLeft(1.00, 900);
                                extendTheBoys(1.00, 8000);
                          } else{
                            ...
                            //knock off right mineral
                                ...
                                turnRight(1.00, 725);
                                driveForward(1.00, 1100);
                                
                                intakeSpin(1.00, 2000);
                                driveForward(-1.00, 2800);
                                turnLeft(1.00, 900);
                                extendTheBoys(1.00, 8000);
